  ...
  return (
    <div className="h-[2700px]">
      <div className="pb-10 relative">
        ...
        <div className="flex gap-5 justify-center top-[8rem] left-0 right-0 absolute ">
          <div className="w-[70%]   rounded-2xl">
            ...
            <div className="box-shadow rounded-2xl mt-5 bg-white pb-5  ">
              ...
              <div className="mt-5 ml-5">
                <Link to="/Twowayresult/selectmeal">
...
export default Twowayseatbooking;
