              ...
              <div className="pl-5 pr-5">
                ...
                {/* <div className="w-[262px]">
                  <div className="flex gap-5">
                    <div className="text-[#1D1D1D] font-semibold  w-[118] h-[20px]">
                      Country code:
                    </div>
                    <div className="text-[#1D1D1D] w-[130] h-[20px]">
                      India (91)
                    </div>
                  </div>
                  <div className="flex gap-5">
...
export default Twowaysreviewdetails;
