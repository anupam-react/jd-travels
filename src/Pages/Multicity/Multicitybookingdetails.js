...
const Multicitybookingdetails = () => {
  return (
    <div className="h-[4200px]">
        ...
        <div className="flex gap-5 justify-center top-[8rem] left-0 right-0 absolute z-20">
          <div className="w-[70%]">
            ...
            <div className="box-shadow rounded-2xl mt-5 bg-white  pb-5 ">
              <div className="flex justify-between p-5 items-center">
                <div className="w-[256px] h-[76px]">
                  <div className="flex items-center w-[300px] font-semibold text-[24px] gap-4">
                    Bengaluru <IoArrowForward />
                    New Delhi
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <div className="box-shadow  rounded-2xl mt-5 pl-5 pr-5   pb-5 ">
              ...
              <div className="mt-2">
                ...
                <div className="mt-5">
                  <Link to="/Milticity/reviewdetails">
...
export default Multicitybookingdetails;
